...
namespace Nitroh.Windows
{
    public static class WindowsHelper
    {
        ...
        #region Read
        public static byte ReadByte(IntPtr handle, long offset)
        {
            byte[] buffer;
            var valid = ReadMemory(handle, offset, 1, out buffer);
        ...
        public static int ReadInt(IntPtr handle, long offset)
        {
            byte[] buffer;
            var valid = ReadMemory(handle, offset, 4, out buffer);
